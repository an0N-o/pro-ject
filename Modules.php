...
#--------------------------------------------------------------------For Scroller ------------------------------------------------------------------------
/*echo "<link rel='stylesheet' type='text/css' href='styles/scrollable-navig.css'>";
echo "<script type='text/javascript' src='js/jquery.tools.min.js'></script>";
echo "<script type='text/javascript' src='js/global-0.32.js'></script>";
echo "<script src='js/jquery.mousewheel.js'></script>";
...
#echo "<a class='prev'></a><div style='float:left; padding-left:3px;'>&nbsp;</div><a class='next'></a>";
...
echo "</div>";
  ...
  <tr>
    <td align='center' class='copyright'>
       <center>Copyright &copy; 2009 Open Solutions for Education, Inc. (<a href='http://www.os4ed.com' target='_blank'>OS4Ed</a>).
